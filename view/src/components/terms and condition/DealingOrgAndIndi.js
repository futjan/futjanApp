...
export default function DealingOrgAndIndi() {
  return (
    <p>
      You acknowledge and agree that FutJan shall not be liable for your
      interactions with any organizations and/or individuals on the Platform or
      ...
      and acknowledge that FutJan shall not be responsible or liable for any
      loss or damage of any sort incurred as the result of any such dealings or
      interactions. If there is a dispute between participants on the Platform,
      or between users and any third party, you understand and agree that FutJan
      ...
      FutJan, its officers, employees, agents, and successors from any and all
