  ...
  return (
    <>
      ...
      <Typography variant="p">
        You expressly acknowledge and agree that use of the platform and the
        service is entirely at your own risk and that the platform and the
        ...
        fullest extent permitted by law FutJan, its officers, directors,
        employees, and agents disclaim all warranties, express or implied, in
        connection with the platform and your use thereof. FutJan makes no
        warranties or representations about the accuracy or completeness of the
        platform's content or the content of any third-party websites linked to
        the platform and assumes no liability or responsibility for any (i)
        ...
        and use of the platform and service, (iii) any unauthorized access to or
        ...
        horses, or the like which may be transmitted to or through the platform
        ...
        made available via the platform or the service. FutJan does not warrant,
        ...
        FutJan will not be a party to or in any way be responsible for
        monitoring any transaction between you and/or other users and/or
