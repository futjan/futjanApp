    ...
    <div id="content">
      ...
      <div className="so-page-builder">
        ...
        <section id="box-link1" class="section-style">
          <div class="container page-builder-ltr" style={{ marginTop: "20px" }}>
                              ...
                              <div class="right-block">
                                <div class="caption">
                                  <h4>
                                    ...
                                    >
                                      Canada Travel One or Two European Facials
                                      at Studio
                                    </a>
                                  </h4>
                    ...
                    >
                      <div class="ltabs-wrap">
                        ...
                        <div class="wap-listing-tabs ltabs-items-container products-list grid">
                          {/* <!--Begin Items--> */}
                          <div
                            class="ltabs-items ltabs-items-selected items-category-1"
                            data-total="16"
                          >
                          ...
                          <div
                            class="ltabs-items items-category-2 grid"
                            data-total="16"
                          >
                            <div class="ltabs-loading"></div>
                          </div>
                          <div
                            class="ltabs-items  items-category-3 grid"
                            data-total="16"
                          >
                            <div class="ltabs-loading"></div>
                          </div>
