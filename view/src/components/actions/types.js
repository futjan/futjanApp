...
export const CREATE_CONVERSATION_SINGLE = "CREATE_CONVERSATION_SINGLE";
...
export const GET_ADMIN_BUSINESSES = "GET_ADMIN_BUSINESSES";
export const GET_CURRENT_USER_BUSINESSES = "GET_CURRENT_USER_BUSINESSES";
export const GET_BUSINESS = "GET_BUSINESS";
export const GET_BUSINESS_KEYWORDS = "GET_BUSINESS_KEYWORDS";
export const DELETE_BUSINESS = "DELETE_BUSINESS";
export const UPDATE_BUSINESS = "UPDATE_BUSINESS";
export const SET_BUSINESS_LOADING = "SET_BUSINESS_LOADING";
export const CLEAR_BUSINESS_LOADING = "CLEAR_BUSINESS_LOADING";
